...
'NewRecord1 Class_Initialize Event @23-6A3507E0
    Private Sub Class_Initialize()
        ...
        Set FileUpload1 = CCCreateFileUpload("FileUpload1","","%TEMP","d:\www\docs\users\hrolivapropiedades.com.ar\search\images","*.jpg;*.gif","",1200000,False)
