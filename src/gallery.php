<?php
//Include Common Files @1-0A075232
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "gallery.php");
...
//Class_Initialize Event @2-94A6EF94
    function clsGridfotos($RelativePath, & $Parent)
    {
        ...
        $this->RowComponents->AddComponent("url", $this->url);
    }
...
//DataSource Variables @2-7811FDEF
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-25D11D8E
...
//Prepare Method @2-8263351E
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlp", ccsInteger, "", "", $this->Parameters["urlp"], -1, false);
...
//Include events file @1-1C6AF9B3
include_once("./gallery_events.php");
...
//Go to destination page @1-F251A12F
if($Redirect)
{
