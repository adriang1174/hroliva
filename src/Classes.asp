...
'clsSQLParameters Class @0-A5DCDF8D
      ...
      Select Case Operator
        ...
        Case opIn, opNotIn
          ...
          If IsArrayParam Then
            For I=1 To UBound(Parameter.Values)
...
'clsSQLParameter Class @0-CDCD59FB
Class clsSQLParameter
  Public Errors
  Public DataType
  Public Format
  ...
  Property Let Link(newLink)
    ...
    Else
      ...
      If UBound(parsedLink) = 1 Then 
        ...
        Else 
          Parameters = Parameters & IIF(Right(Parameters, 1) = "&" , "","&") & parsedLink(1) 
        End If
      Else
        Parameters = ""
      End If
...
'clsFileUpload Class @0-5157E68A
Class clsFileUpload
  Public Name
  Public CCSEvents
  Public Visible
...
'clsDatePicker Class @0-E2CA1075
Class clsDatePicker
  Public Name
  Public ExternalName
  Public FormName
...
'clsListControl Class @0-C3C2A4DA
Class clsListControl
  Private Control
...
'clsFlashChart class @0-0298D45C
Class  clsFlashChart
  Public Name
  Public CCSEvents
  Public Visible
...
'CCCreateMenuNode function @0-CBF938EF
